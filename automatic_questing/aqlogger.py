...
from automatic_questing.helpers import mkdir_p
...
class BlacklistFilter(Filter):
    ...
    """
    filename = "AutomaticQuesting.log"
    max_size = 5000000  # 5 MB
    max_files = 5
    log_folder = 'logs'

    blacklisted_strings = ['address',  'rpc']

    def __init__(self, filtered_strings):
        super().__init__()
        self.filtered_strings = filtered_strings
